...
namespace EMMAIntegratedTests
{
    public class PersonControllerTests
    {
        ...
        {
            var input = new Person { Name = "Teste", Email = "teste@local", Password = "1234", Role = "Admin" };
            ...
            Assert.Equal(nameof(PersonController.Get), actionResult.ActionName);
            var value = actionResult.Value as Person;
            Assert.NotNull(value);
            Assert.Equal(42, value.IdPerson);
        }
    }
}
